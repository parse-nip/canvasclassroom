...
Try adding "turn right (90) degrees" after moving to make it turn!`,
  steps: [
    ...
    'Change the number in "move (10) steps" to 50. Click the flag',
    ...
    'Try "change x by (10)" instead of "move (10) steps"',
    '[TEXT] What\'s different?',
    'Experiment! Try different numbers and different blocks',
